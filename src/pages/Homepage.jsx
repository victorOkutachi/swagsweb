  ...
  return (
    ...
    <div className=' w-full h-full'>
        ...
        className=' w-full h-[600px] md:h-[900px] bg-cover lg:bg-cover bg-center bg-no-repeat'>
            ...
            <h1 className=' text-[25px] md:text-[45px] font-Dancing text-white mb-6 text-bold'>ABOUT</h1>
        ...
        className=' w-full h-full bg-cover lg:bg-cover bg-center bg-no-repeat'>
            ...
            <button className='text-[#eba95d] bg-white font-bold text-[12px] md:text-[16px] rounded-full hover:text-white border-[2px] hover:bg-[#eba95d] border-white hover:border-white px-6 py-1 md:w-[160px] md:py-3 md:px-8 w-[100px] flex items-center justify-center mt-20 mx-auto md:mx-0'>
                Explore
            </button>
            ...
            <button className='text-[#eba95d] bg-white font-bold text-[12px] md:text-[16px] rounded-full hover:text-white border-[2px] hover:bg-[#eba95d] border-white hover:border-white px-6 py-1 md:w-[160px] md:py-3 md:px-8 w-[100px] flex items-center justify-center my-3 mx-auto md:mx-0' data-aos='fade-left'>
                Listen
            </button>
            <h2 className='text-[18px] text-white my-2 font-Kanit text-bold'>Available on:</h2>
            <div className='flex w-full items-center justify-center mx-auto py-2'>
