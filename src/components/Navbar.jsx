...
const Navbar = () => {
  ...
  return (
    <div className='flex w-full h-12 items-center justify-between p-10 absolute shadow-sm'>
        <div>
            <h1 className='text-white font-Whisper lg:text-[35px]'>IamElswag</h1>
        ...
        <div onClick={handleMenu} className='block md:hidden z-10'>
             {menu ? <AiOutlineClose color='white' size={20} /> : <HiOutlineMenuAlt2 color='white' size={20}/>}     
        </div>
        <div className={menu ? 'absolute left-0 top-0 w-full h-screen flex flex-col items-center justify-center bg-[#007f5f] ease-in-out duration-500 text-white' : 'fixed left-[-100%]'}>
                <ul className='uppercase p-4'>
                    ...
                    <li className='py-2 text-xl font-medium'></li>
                    <li className='py-2 text-xl font-medium'></li>
